...
INSERT INTO empleados (nombre, apellido, correo, telefono, fecha_contratacion, id_jefe, titulo_puesto) VALUES
  ('Yanet', 'Meneses', 'yameneses@gmail.com', '123-456-7890', '2023-01-01', NULL, 'Gerente'),
  ('Ana', 'Martinez', 'ana.martinez@gmail.com', '987-654-3210', '2023-02-15', 1, 'Supervisor'),
  ('Carlos', 'Lopez', 'carlos.lopez@gmail.com', '555-555-5555', '2023-03-20', 2, 'Asistente');
