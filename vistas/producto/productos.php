...
foreach ($categorias as $categoria) {
    ...
    foreach ($productos as $producto) {
        ...
        if ($producto['id_categoria'] == $categoria['id_categoria']) {
            ...
            // echo '<a href="#" class="minus-button" data-id="' . $producto['id_producto'] . '"><i class="fa-solid fa-minus" style="color: #038de9"></i></a>';
            // echo '<p class="cantidad">1</p>';
            // echo '<a href="#" class="plus-button" data-id="' . $producto['id_producto'] . '"><i class="fa-solid fa-plus" style="color: #038de9"></i></a>';
            // echo '</div>';
            // echo '<br>';
